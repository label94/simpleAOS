...
import co.aos.appbar.annotations.ExperimentalToolbarApi
import co.aos.appbar.utils.ScrollStrategy
import kotlin.math.max

/**
 * Collapsing + toolbar 전용 커스텀 컴포저블
 * - 스크롤 시 툴바 영역을 확장하거나, 닫을 수 있는 UI
 * 참고 : https://github.com/onebone/compose-collapsing-toolbar
 * */
